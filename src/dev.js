const devTools = {
	...
	scalingMethodHue: function(hue1 = 0, hue2 = Math.PI, count = 1609, method = OkLCh.HueMethod.Longer) {
		let method1 = method;
		let method2 = method;
		if (method === OkLCh.HueMethod.Longer || method === OkLCh.HueMethod.Shorter) {
			method1 = OkLCh.HueMethod.Longer;
		...
		// const col1_sRGB = OkLCh.OkLChTosRGB(col1_OkLCh);
		// const col2_sRGB = OkLCh.OkLChTosRGB(col2_OkLCh);
